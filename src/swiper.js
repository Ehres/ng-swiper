  ...
  .provider('$swiper', function() {
    ...
    this.$get = function() {
      function SwiperFactory(element, config, $rootScope) {
        ...
        events.onFirstInit = function(swiper){
          console.log('first init : ', swiper);
        };

        events.onInit = function(swiper){
          console.log('init : ', swiper);
        };

        events.onSwiperCreated = function(swiper){
          console.log('onSwiperCreated : ', swiper);
        };

        options = angular.extend(options, events);
        $swiper = new Swiper('#' + element.id, options);
      }
